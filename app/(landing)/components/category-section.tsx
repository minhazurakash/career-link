    ...
    <Container>
      ...
      <div className="grid gap-4 md:grid-cols-2 md:gap-6 xl:grid-cols-4">
        {categories.map(([title, count]) => (
          <div
            className="group flex cursor-pointer items-center gap-4 rounded-xl bg-white p-5 transition-all hover:shadow-[0_12px_48px_rgba(0,44,109,0.1)] md:p-6"
            key={title}
          >
            <span className="flex size-16 shrink-0 items-center justify-center rounded-lg bg-[#e7f0fa] text-[#0a65cc] transition-colors group-hover:bg-[#0a65cc] group-hover:text-white md:size-[68px]">
              <BriefcaseIcon className="size-7 md:size-8" />
            </span>
            <span>
